...
def fire_bullet(ai_settings,screen,ship,bullets):
	"""Выпускает пулю,если максимум еще не достгнут"""
...
def update_screen(ai_settings,screen,stats,sb,ship,aliens,bullets,play_button):
	"""Обновляет мзображения на экране и отображает новый экран"""
...
def get_number_aliens_x(ai_settings,alien_width):
	"""Вычисляет количство пришельцев в ряду"""
...
def create_alien(ai_settings,screen,aliens,alien_number,row_number):
	"""Создает приешльца и размещает его в ряду"""
...
def ship_hit(ai_settings,stats,screen,ship,aliens,bullets):
	"""Обрабатывает столкновение корабля м пришельцем"""
...
def check_fleet_edges(ai_settings,aliens):
	"""Реагирует а достижение пришельцем края экрана"""
	for alien in aliens.sprites():
